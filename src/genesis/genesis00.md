...
<img class="intro-left" src="/images/logo-theologicus3.png">Why Genesis? The pat answer is that it is beginning of everything that God has done. Everything we read from Exodus on, including and especially in the Gospels, can be traced right back to the first instance in Genesis.
